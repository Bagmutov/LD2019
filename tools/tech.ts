...
export function drawTextBox(ctx,x,y,r,w=ctx.canvas.width,h=ctx.canvas.height,text:string|string[] ='', fontSize:number, {boxclr='#ffffff', textclr='#000000',off={x:0,y:0}}){
